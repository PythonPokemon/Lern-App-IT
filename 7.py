...
class LearningApp(App):
    def __init__(self, **kwargs):
        ...
        continue_button = Button(text='Fortfahren', on_release=self.dismiss_popup)
    ...
    def restart_learning(self, instance):
        # Zurücksetzen des Lernfortschritts hier implementieren
        self.popup.dismiss()
    ...
    def on_start(self):
        ...
        continue_button = Button(text='Fortfahren', on_release=self.popup.dismiss)
        restart_button = Button(text='Von vorne beginnen', on_release=self.restart_learning)
    ...
    def on_stop(self):
        self.save_all_progress()  # Fortschritt für alle Lernfelder und Fragen speichern
